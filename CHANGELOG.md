...
- A sandboxed, stdin-only PlantUML renderer with bounded SVG/PNG artifacts, a frozen public limit contract, single-pass SVG document validation, source metadata suppression, standard-report error detection, and child termination on stream failures.
